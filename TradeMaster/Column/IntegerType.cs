...
namespace TradeMaster.Column {
    public class IntegerType : IDataErrorInfo {
        ...
        public IntegerType(string colName, string tag) {
        ...
        private void SetBorder() {
            try {
                Border = App.Current.FindResource("IntegerType") as Border;
            }
